...
const Carusel = () => {
  ...
  const data = [
    ...
    'Para este proyecto se utilizó únicamente CSS con el fin de conocer a profundidad conceptos de este lenguaje  tales como posicionamiento y layout. Como se puede observar en la imágen el diseño que se llevó al html fue un stitch.',
